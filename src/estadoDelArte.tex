...
El motor de \textit{PacketShader}~\cite{dpdk:packetshader} fue diseñado inicialmente para ser un router, con la ayuda de una \gls{gpu}, con capacidad de trabajar a tasas de varias decenas de~Gbps. No obstante, 
